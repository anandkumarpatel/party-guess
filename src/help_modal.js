    ...
    <Modal handleModalClose={handleModalClose}>
      ...
      {isIOS && (
        <>
          ...
          <p className='Modal-copy'>
            Open up settings on your device, go to "Safari" and make sure <span className='Modal-emphasis'>"Motion &amp; Orientation Access" is toggled ON</span>.{' '}
            <em>Note: This might require you to restart your device in order for the setting to bake in.</em>
          </p>
        </>
      )}
